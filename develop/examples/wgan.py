...
from gan.utils import create_GAN_loss_func, WGAN_loss
...
from flash.func import weight_clipping
manager.add_post_operator('clip', weight_clipping(weight_clip_param))



update1 = {'name' : 'D', 'model' : 'GAN', 'loss_fn' : 'D', 'optimizer' : 'D', 'num_iter' : n_critic, 'pre_operator' : 'D', 'post_operator' : 'clip'}
